<table style="width: 100%; border-collapse: collapse; font-family: 'Times New Roman'; font-size: 12px; text-align: center;">
    ...
    <tbody>
        ...
        <tr style="font-weight: bold;">
            <td style="font-family: 'Times New Roman';font-size:12px; text-align:center;border: 1px solid black; vertical-align: middle;"></td>
            <td style="font-family: 'Times New Roman';font-size:12px; text-align:left;font-weight:bold;border: 1px solid black; vertical-align: middle;">Барлығы / Всего</td>
            <td style="font-family: 'Times New Roman';font-size:12px; text-align:center;border: 1px solid black; vertical-align: middle;"></td>
            <td style="font-family: 'Times New Roman';font-size:12px; text-align:center;border: 1px solid black; vertical-align: middle;"></td>
            <td style="font-family: 'Times New Roman';font-size:12px; text-align:center;border: 1px solid black; vertical-align: middle;"></td>
            <td style="font-family: 'Times New Roman';font-size:12px; text-align:center;border: 1px solid black; vertical-align: middle;"></td>
    ...
    <tr>
        <td style="font-family: 'Times New Roman';font-size:12px; text-align:left;border: 1px solid black; vertical-align: middle;" colspan="7">
    ...
    @for($i=0; $i<4; $i++)
    <tr>
        <td colspan="1" style="font-family: 'Times New Roman';font-size:12px; text-align:center;border: 1px solid black; vertical-align: middle;"></td>
        <td colspan="4" style="font-family: 'Times New Roman';font-size:12px; text-align:center;border: 1px solid black; vertical-align: middle;"></td>
...
<table style="width: 100%; border-collapse: collapse; font-family: 'Times New Roman'; font-size: 12px; text-align: center;">
    <thead>
        ...
        <tr>
            <th colspan="7" style="font-family: 'Times New Roman';font-size:12px; text-align:left;vertical-align: middle;">
                2 АКАДЕМИЯЛЫҚ КЕЗЕҢ / 2 АКАДЕМИЧЕСКИЙ ПЕРИОД
            </th>
        </tr>
        <tr style="font-family: 'Times New Roman';font-size:12px; text-align:center;border: 1px solid black; vertical-align: middle;">
            <th style="font-family: 'Times New Roman';font-size:12px; text-align:center;border: 1px solid black; vertical-align: middle;">рр/с<br>№<br>п/п</th>
